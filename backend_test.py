...
def main():
    ...
    def test_streaming_endpoint_pro_version(self):
        ...
        success, response = self.run_test(
            "Create Conversation for PRO Streaming Test",
            "POST",
            "conversations",
            200,
            data={"title": "PRO Streaming Test"}
        )
    ...
    def test_streaming_endpoint_free_version(self):
        ...
        success, response = self.run_test(
            ...
            "conversations",
            200,
            data={"title": "FREE Streaming Test"}
        )
    ...
    def test_streaming_error_handling(self):
        ...
        # Create conversation for error handling test
        success, response = self.run_test(
            "Create Conversation for Streaming Error Test",
            "POST",
            "conversations",
            200,
            data={"title": "Streaming Error Test"}
        )
    ...
    def test_deepseek_parameters(self):
        ...
        success, response = self.run_test(
            "Create Conversation for DeepSeek Parameters Test",
            "POST",
            "conversations",
            200,
            data={"title": "DeepSeek Parameters Test"}
        )
    ...
    def test_stream_format_validation(self):
        ...
        success, response = self.run_test(
            "Create Conversation for SSE Format Test",
            "POST",
            "conversations",
            200,
            data={"title": "SSE Format Test"}
        )
